...
version = ".".join(map(str, module.version_tuple[:-1]))
# The full version, including alpha/beta/rc tags.
release = ".".join(map(str, module.version_tuple))
...
man_pages = [(master_doc, "aiomisc", "aiomisc Documentation", [author], 1)]
